# This Makefile is for the POE::Filter::XML extension to perl.
#
...
#     NAME => q[POE::Filter::XML]
#     PREREQ_PM => { PXR=>q[0], POE=>q[0] }
#     VERSION_FROM => q[POE/Filter/XML.pm]
...
FULLEXT = POE/Filter/XML
BASEEXT = XML
PARENT_NAME = POE::Filter
DLBASE = $(BASEEXT)
VERSION_FROM = POE/Filter/XML.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
TO_INST_PM = lib/POE/Filter/XML.pm \
	lib/POE/Filter/XML/Handler.pm \
	lib/POE/Filter/XML/Meta.pm

PM_TO_BLIB = lib/POE/Filter/XML/Handler.pm \
	blib/lib/POE/Filter/XML/Handler.pm \
	lib/POE/Filter/XML.pm \
	blib/lib/POE/Filter/XML.pm \
	lib/POE/Filter/XML/Meta.pm \
	blib/lib/POE/Filter/XML/Meta.pm
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/POE/Filter/XML/Handler.pm blib/lib/POE/Filter/XML.pm
	rm -f blib/lib/POE/Filter/XML/Meta.pm
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{lib/POE/Filter/XML/Handler.pm blib/lib/POE/Filter/XML/Handler.pm lib/POE/Filter/XML.pm blib/lib/POE/Filter/XML.pm lib/POE/Filter/XML/Meta.pm blib/lib/POE/Filter/XML/Meta.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
